This will to dynamic load po lang files in your msegui application.
It does not uses the mseconst_xx.pas of each language and so does not bloat up your application.

User may add new po file without the need to recompile the application.

Just copy + paste all the files in /src into the root source directory of your application.

There are 2 files for languages arrays to adapt: mseconst.pas for the default data and msestockobjects.pas for the enums.
  ...
  This are custom arrays needed by the applications you may adapt it as you want:
   lang_langnames, lang_mainform, lang_settings, lang_actionsmodule, lang_projectoptionscon, lang_projectoptions,
